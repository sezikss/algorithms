<h2><a href="https://leetcode.com/problems/baseball-game">682. Baseball Game</a></h2><p>You are keeping the scores for a baseball game with strange rules. At the beginning of the game, you start with an empty record.</p>
