<h2><a href="https://leetcode.com/problems/valid-number">65. Valid Number</a></h2><p>Given a string <code>s</code>, return whether <code>s</code> is a <strong>valid number</strong>.<br />
<br />
